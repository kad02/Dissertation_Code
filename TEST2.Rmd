...
```{r}
# STAGE 1
StageOne_2 <- function(n_sim, n, lambda, tau, sigma, theta1, theta2){
  # Calculate theta3
...
```{r}
Trial2 <- function(n_sim, n, lambda, tau, sigma, theta1, theta2, stage1, par){
...
Utility_Optimise2 <- function(n_sim, n, lambda, tau, sigma, theta1, theta2, stage1, par){
  trial <- Trial2(n_sim, n, lambda, tau, sigma, theta1, theta2, stage1, par)
...
stage1 <- StageOne_2(n_sim, n, lambda, tau, sigma, theta1, theta2)




start.time <- Sys.time()
optim(Utility_Optimise2, 
       par = c(1, 0), 
       n_sim = n_sim, 
       n = n, 
       lambda = lambda, 
