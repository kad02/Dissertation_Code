...
```{r}
# STAGE 1
StageOne_1 <- function(n_sim, n, lambda, tau, sigma, theta1, theta2, par){
  # Calculate theta3
...
```{r}
Trial <- function(n_sim, n, lambda, tau, sigma, theta1, theta2, par){
  stage1 <- StageOne_1(n_sim, n, lambda, tau, sigma, theta1, theta2, par)
...
Utility_Optimise <- function(n_sim, n, lambda, tau, sigma, theta1, theta2, par){
  trial <- Trial(n_sim, n, lambda, tau, sigma, theta1, theta2, par)
